...
public class CurrentWeatherService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        String latitude = preferences.getString(Constants.APP_SETTINGS_LATITUDE, "21.02");
        String longitude = preferences.getString(Constants.APP_SETTINGS_LONGITUDE, "105.84");


        String requestResult = "";
        HttpURLConnection connection = null;
        try {
            URL url = Utils.getWeatherForecastUrl(Constants.WEATHER_ENDPOINT, latitude, longitude, longitude,latitude);
